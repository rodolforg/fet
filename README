...
Requirements:
	...
	FET is created in the following environment: openSUSE Leap 42.2 GNU/Linux distribution, Linux 4.4.57, Xfce 4.12,
	Midnight Commander 4.8.18, KDiff3 0.9.98, Qt 5.8.0, gcc 6.3.1, g++ 6.3.1, make 4.0, sed 4.2.2,
	Valgrind 3.11.0, Coverity Scan 8.7.0, Cppcheck 1.78, other great free tools.
	FET can be run on any platform supported by the free software Qt (GNU/Linux, Windows, Mac OS X).

	GNU/Linux, Mac OS X:
	Software:
		make 4.0 or similar (GNU Make)
		gcc 6.3.1 or similar
		g++ 6.3.1 or similar (or gcc-g++, or gcc-c++, the name may vary. This program may be included in the gcc package)
		Qt 5.8.0 or compatible (The authors also tried to maintain backwards source compatibility with Qt 4.v.v).
...
Getting - compiling - installing Qt:
	...
	You will need Qt 5.8.0 or compatible to compile FET (The authors also tried to maintain backwards source compatibility with Qt 4.v.v).
	...
	(some usual locations are /usr/share/qt5/mkspecs or /usr/lib/qt5/mkspecs on GNU/Linux or C:\Qt\5.8.0\mkspecs on Windows).
...
Compiling FET:
	...
	Currently FET can be compiled with a C++ compiler, using Qt version 5.8.0 or compatible.
	...
	GNU/Linux:
	- You will need Qt 5.8.0 or compatible to compile this program.
	...
	3. Another variant, if you use the Clang C++ compiler (which seems to be the default for Qt 5.8.0 on Mac):
	It seems that you need to type:
	"/Users/Yourname/Qt5.8.0/5.8/clang_64/bin/qmake -r -spec /Users/Yourname/Qt5.8.0/5.8/clang_64/mkspecs/macx-clang", then "make"
	...
	Windows: MinGW C++ compiler: you need Qt 5.8.0 or compatible, and MinGW.
