...
Requirements:
	...
	FET is created in the following environment: openSUSE Leap 42.3 GNU/Linux distribution, Linux 4.4.87, Xfce 4.12,
...
Getting - compiling - installing Qt:
	...
	You will need Qt 5.9.2 or compatible to compile FET (The authors also tried to maintain backwards source compatibility with Qt 4.v.v).
	...
	(some usual locations are /usr/share/qt5/mkspecs or /usr/lib/qt5/mkspecs on GNU/Linux or C:\Qt\5.9.2\mkspecs on Windows).
...
Compiling FET:
	...
	Currently FET can be compiled with a C++ compiler, using Qt version 5.9.2 or compatible.
	...
	GNU/Linux:
	- You will need Qt 5.9.2 or compatible to compile this program.
	...
	3. Another variant, if you use the Clang C++ compiler (which seems to be the default for Qt 5.9.2 on Mac):
	It seems that you need to type:
	"/Users/Yourname/Qt5.9.2/5.9.2/clang_64/bin/qmake -r -spec /Users/Yourname/Qt5.9.2/5.9.2/clang_64/mkspecs/macx-clang", then "make"
	...
	Windows: MinGW C++ compiler: you need Qt 5.9.2 or compatible, and MinGW.
